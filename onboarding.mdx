...
<Steps>
  ...
  <Step title="La diffuser partout">
    ...
    Le [Guide d'installation](/guide-installation) détaille la manipulation **portail par portail** : SeLoger, Leboncoin, Bien'ici, Jinka, Immojeune, La Carte des Colocs, et les logiciels AC3-Immofacile, Netty/Modelo et Hektor.
...
<AccordionGroup>
  ...
  <Accordion title="Prendre l'habitude de renseigner l'origine">
    Le champ **Origine de la demande** est la seule source du graphique le plus utile des statistiques : celui qui vous dit quel portail vous rapporte des locataires, et pas seulement des contacts.

    Une origine saisie au hasard rend cette analyse inexploitable — et cela ne se rattrape pas rétroactivement. Prenez le pli dès le premier jour.
  </Accordion>
</AccordionGroup>
...
| # | Étape | Où | Dépend de |
| --- | --- | --- | --- |
| 1 | Demander la connexion multi-diffuseur | Multi-diffuseurs (CRM) | **Validation externe** |
| 1 | Demander le nom d'expéditeur SMS | Support Uplace | **Déclaration opérateurs** |
| 2 | Fiche agence : logo, nom, SIRET, e-mail | Fiche agence | — |
| 2 | Discussions et affichage public | Fiche agence | — |
| 3 | Logo e-mail et couleur | Personnaliser mes échanges | Formule marque grise |
| 4 | Plages de critères pré-définis | Critères pré-définis | — |
| 4 | GLI pré-remplies | GLI pré-remplies | — |
| 4 | Formulaires modulables | Formulaire modulable | — |
| 5 | Inviter les membres et attribuer les rôles | Mon agence | Sièges disponibles |
| 5 | Réglage individuel des notifications | Mes notifications | Chaque membre |
| 6 | Diffuser l'adresse `@inbox.uplace.fr` | Boîte de réception | — |
| 7 | Créer le premier lot | Dashboard | Étape 4 recommandée |
| 8 | Synchro calendriers, vitrine, sous-traitants | Divers | — |

## Les cinq erreurs de mise en route les plus coûteuses
...
<Warning>
  ...
  5. **Négliger le champ « origine de la demande » les premières semaines.** Vos statistiques par canal seront inexploitables, et c'est irrattrapable rétroactivement.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Récapitulatif du parcours" icon="route" href="/recapitulatif">
    Le parcours locatif de bout en bout, une fois la configuration faite.
  </Card>
