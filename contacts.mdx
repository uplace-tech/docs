...
<Steps>
  ...
  <Step title="Lire chaque ligne">
    Pour chaque contact : identité, coordonnées (copie en un clic, appel, WhatsApp), **bien concerné** (avec lien vers la fiche du lot), **statut** d'avancement, puis les indicateurs du dossier : **revenus**, **garant** et **cohérence** (Excellent, Bon…).
  </Step>
...
<AccordionGroup>
  <Accordion title="Quelle différence avec « Mes candidats » ?">
    **Contacts** montre l'activité à traiter sur les lots actifs. [Mes candidats](/prospects) est la base de fond de l'agence, tous lots et toutes périodes confondus.
  </Accordion>
