...
- Après un refus, proposez un autre bien de l'agence depuis [Mes candidats](/boite-reception) : le candidat est encore en recherche active — voir [Candidater sur un autre lot](/candidater-autre-lot).
...
<AccordionGroup>
  ...
  <Accordion title="Comment faire candidater cette personne sur un autre bien ?">
    Le bouton **Partager les lots** se trouve dans [Mes candidats](/boite-reception), pas ici. Trois autres chemins existent — voir [Candidater sur un autre lot](/candidater-autre-lot).
  </Accordion>
